...
//     styleText(
//       "green",
//       "\nCrafting Good System Prompts for AI Assistants:\nThis is a simple CLI tool that uses different system prompts to process different inputs.",
//     ),
//   );
...
//     3. Use 'Ctrl + C' or 'Cmd + C' to exit.
//     -----------------------------------------------
//   `);

//   let answer = await menuSelection();
//   while (answer !== "exit") {
//     answer = await menuSelection();
//   }
//   // Here, answer is 'Exit'
